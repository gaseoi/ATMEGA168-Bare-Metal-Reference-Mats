/* 
    From Elliot Williams https://github.com/hexagon5un/AVR-Programming/ with modifications.
...
/* Prints a signed 16-bit integer in decimal (prints a leading '-' for negative)
   Use this for sensor values that can be negative. */
